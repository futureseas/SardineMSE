# De-bugging convergence for SSMSE
...
# EMmodelPath <- "C:/Users/r.wildermuth/Documents/FutureSeas/SardineMSE/scenarioModels/start1981/OM/OM_K"
...
sample_struct_list <- list("testConvrgOM_KandEM_K_RandRec_EM" = sample_struct)

# figure out the recruitment deviation input ---------------

# define scenario name
scenName <- "testConvrgOM_KandEM_K_RandRec_EM"
iters <- 3
...
#                     # value = rep(recSST$recDevSST_GFDL, times = iters))
...
out <- run_SSMSE(scen_name_vec = scenName, # name of the scenario
                 ...
                 EM_name_vec = "testConvrgEM_K", # cod is included in package data
...
test2041 <- SS_output(dir = "C:/Users/r.wildermuth/Documents/FutureSeas/scenarioRuns/start1981HCR6serverRuns/1/margCompsOMfixedSelexEM_EM_2041")
SS_plots(test2041)

test2031 <- SS_output("C:/Users/r.wildermuth/Documents/FutureSeas/scenarioRuns/start1981HCR6serverRuns/1/margCompsOMfixedSelexEM_EM_2031")
SS_plots(test2031)
