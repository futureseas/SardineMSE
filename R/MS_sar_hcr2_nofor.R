...
MS_sar_hcr2_nofor = function(EM_out_dir = NULL, 
  ...
  #the EM starter file specifies 1 forecast year, so only 1 value should be available, but just in case specify first value is used
  bio1 = EMts$Bio_Smry.1[dim(EMts)[1]]
