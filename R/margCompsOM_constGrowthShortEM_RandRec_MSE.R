...
sample_struct_list <- list("margCompsOM_constGrowth2001EM_RandRecHCR1" = sample_struct)

# figure out the recruitment deviation input ---------------

# define scenario name
scenName <- c("margCompsOM_constGrowth2001EM_RandRecHCR1")
iters <- 2
...
rec_dev_specify$input$first_yr_averaging <- 2001 #datfile$styr
...
out <- run_SSMSE(scen_name_vec = scenName, # name of the scenario
                 ...
                 EM_name_vec = "margCompsOM_constGrowthShortEM", # Can't have number in name for summary diagnostics to work
