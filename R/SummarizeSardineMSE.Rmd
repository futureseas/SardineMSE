...
scenarios <- c("constGrow2001OM_constGrow2005EM_RegRecHCR0",
  ...
  #         file = file.path(mseDir, "serverRegARPDOcyclPDOclimSSTMICE_allHCRs_results.RDS"))
...
termRE %>% filter(plotGroup != "non-convrg") %>%
  ...
  scale_fill_manual(values = hcrPal[-1], labels = c("PFMCF018", "PFMCFSST",
                                                "ConstF", "Pikitch", "40-10",
                                                "DynPik", "Dyn40-10")) +
  labs(caption = "Violin plot of the mean assessment relative error in the assessment year for Age1+ biomass.\nMeans over model assessment and year, levels of boxplot are 25th, 50th, and 75th quartiles, whiskers are 1.5IQR.") +
  theme(plot.caption = element_text(hjust = 0),
        plot.caption.position = "plot")
...
lag1RE %>% filter(plotGroup != "non-convrg") %>%
  ...
  scale_fill_manual(values = hcrPal[-1], labels = c("PFMCF018", "PFMCFSST",
                                                "ConstF", "Pikitch", "40-10",
                                                "DynPik", "Dyn40-10")) +
  labs(caption = "Violin plot of the mean assessment relative error 1 year preceding assessment for Age1+ biomass.\nMeans over model assessment and year, levels of boxplot are 25th, 50th, and 75th quartiles, whiskers are 1.5IQR.") +
  theme(plot.caption = element_text(hjust = 0),
        plot.caption.position = "plot")
...
lag2RE %>% filter(plotGroup != "non-convrg") %>%
  ...
  scale_fill_manual(values = hcrPal[-1], labels = c("PFMCF018", "PFMCFSST",
                                                "ConstF", "Pikitch", "40-10",
                                                "DynPik", "Dyn40-10")) +
  labs(caption = "Violin plot of the mean assessment relative error 2 years preceding assessment for Age1+ biomass.\nMeans over model assessment and year, levels of boxplot are 25th, 50th, and 75th quartiles, whiskers are 1.5IQR.") +
  theme(plot.caption = element_text(hjust = 0),
        plot.caption.position = "plot")
...
lag3RE %>% filter(plotGroup != "non-convrg") %>%
  ...
  scale_fill_manual(values = hcrPal[-1], labels = c("PFMCF018", "PFMCFSST",
                                                "ConstF", "Pikitch", "40-10",
                                                "DynPik", "Dyn40-10")) +
  labs(caption = "Violin plot of the mean assessment relative error 3 years preceding assessment for Age1+ biomass.\nMeans over model assessment and year, levels of boxplot are 25th, 50th, and 75th quartiles, whiskers are 1.5IQR.") +
  theme(plot.caption = element_text(hjust = 0),
        plot.caption.position = "plot")
...
foreRE %>% filter(plotGroup != "non-convrg") %>%
  ...
  scale_fill_manual(values = hcrPal[-1], labels = c("PFMCF018", "PFMCFSST",
                                                "ConstF", "Pikitch", "40-10",
                                                "DynPik", "Dyn40-10")) +
  labs(caption = "Violin plot of the mean assessment relative error for a 1 year forecast for Age1+ biomass.\nMeans over model assessment and year, levels of boxplot are 25th, 50th, and 75th quartiles, whiskers are 1.5IQR.") +
  theme(plot.caption = element_text(hjust = 0),
        plot.caption.position = "plot")
