...
scenarios <- c("constGrow2001OM_constGrow2005EM_RegRecHCR0",
  ...
  saveRDS(smryOutputList,
          file = file.path(mseDir,
                           "serverRegARPDOcyclSST_allHCRs_results.RDS"))
# smryOutputList <- readRDS(file.path(mseDir, "serverRegARMeanSSTPDOcycl_allHCRs_results.RDS"))
