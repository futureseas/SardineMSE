# Code to test a constant growth model starting in 2001 with recruitment driven by cyclic PDO
...
sample_struct_list <- list("constGrow2001OM_constGrow2005EM_PDOcyclRecHCR0" = sample_struct,
                           "constGrow2001OM_constGrow2005EM_PDOcyclRecHCR1" = sample_struct,
                           "constGrow2001OM_constGrow2005EM_PDOcyclRecHCR2" = sample_struct,
                           "constGrow2001OM_constGrow2005EM_PDOcyclRecHCR3" = sample_struct,
                           "constGrow2001OM_constGrow2005EM_PDOcyclRecHCR5" = sample_struct,
                           "constGrow2001OM_constGrow2005EM_PDOcyclRecHCR6" = sample_struct,
                           "constGrow2001OM_constGrow2005EM_PDOcyclRecHCR7" = sample_struct,
                           "constGrow2001OM_constGrow2005EM_PDOcyclRecHCR8" = sample_struct,
                           "constGrow2001OM_constGrow2005EM_PDOcyclRecHCR9" = sample_struct)

# figure out the recruitment deviation input ---------------

# define scenario name
scenName <- c("constGrow2001OM_constGrow2005EM_PDOcyclRecHCR0",
