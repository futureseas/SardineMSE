# Function to read recruitment deviations from a no catch scenario, negate them,
# and apply a set of 9 HCRs to the new rec dev series.
...
RunInverseScenarios <- function(scenVec, # character vector of 9 scenarios, including one HCR0 scenario
  ...
  sample_struct_list <- list(sample_struct, sample_struct, sample_struct, 
                             sample_struct, sample_struct, sample_struct, 
                             sample_struct, sample_struct, sample_struct)
  names(sample_struct_list) <- scenVec
  ...
  noCatScen <- grep("HCR0", scenVec, fixed = TRUE, value = TRUE)
  noCatScen <-  sub("inv", "", noCatScen)
  recUserDef <- read.csv(file.path(mseOutputPath, noCatScen,
                                   paste0("results_ts_", noCatScen, ".csv")))
  ...
  rand_dev_list0and1 <- rand_dev_list
  rand_dev_list0and1[[1]]$input <- rand_dev_list0and1[[1]]$input %>% filter(scen %in% scenName[1:2])
  ...
  out0and1 <- run_SSMSE(scen_name_vec = scenName[1:2], # name of the scenario
                   ...
                   future_om_list = rand_dev_list0and1, 
  ...
  rand_dev_list2[[1]]$input <- rand_dev_list2[[1]]$input %>% filter(scen %in% scenName[3])
  ...
  rand_dev_list3 <- rand_dev_list
  rand_dev_list3[[1]]$input <- rand_dev_list3[[1]]$input %>% filter(scen %in% scenName[4])
  ...
  rand_dev_list5 <- rand_dev_list
  rand_dev_list5[[1]]$input <- rand_dev_list5[[1]]$input %>% filter(scen %in% scenName[5])
  ...
  rand_dev_list6 <- rand_dev_list
  rand_dev_list6[[1]]$input <- rand_dev_list6[[1]]$input %>% filter(scen %in% scenName[6])
  ...
  rand_dev_list7 <- rand_dev_list
  rand_dev_list7[[1]]$input <- rand_dev_list7[[1]]$input %>% filter(scen %in% scenName[7])
  ...
  rand_dev_list8 <- rand_dev_list
  rand_dev_list8[[1]]$input <- rand_dev_list8[[1]]$input %>% filter(scen %in% scenName[8])
  ...
  rand_dev_list9[[1]]$input <- rand_dev_list9[[1]]$input %>% filter(scen %in% scenName[9])
